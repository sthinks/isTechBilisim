...
function ContactBottom() {
    return (
        <div className="h-3/5 w-[70%] bg-white  flex flex-row shadow-contactShadow justify-between contact-bottom max-md:w-[90%] max-md:flex-col max-md:h-full max-lg:flex-col  ">
            <div className="flex-1 flex justify-center items-center">
                <ContactData />
            </div>
            <div className="flex-1">
                <iframe
                    className="w-full h-full max-lg:h-[350px]"
                    title="adress"
